...
if __name__ == '__main__':
    ...
    for fold, (tr_idx, va_idx) in enumerate(gkf.split(X, y, groups)):
        ...
        model.booster_.save_model(f'track6_gbm_fold{fold}.txt')

    pickle.dump(dict(FEATCOLS=FEATCOLS, pf_col=pf_col), open('track6_gbm_meta.pkl', 'wb'))
    print('saved 5 fold models (track6_gbm_fold{0-4}.txt) + track6_gbm_meta.pkl')
