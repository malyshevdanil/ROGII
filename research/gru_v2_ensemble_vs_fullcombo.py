...
from gru_refiner import build_dataset, CFG
...
ens_preds = pickle.load(open('gru_refiner_v2_ensemble_preds.pkl', 'rb'))
...
print('gru ensemble solo:', pooled('gru', VA))
...
for w_test in [0.1, 0.15, 0.2, 0.3, 0.5]:
